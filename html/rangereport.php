  ...
  ?>
        ...
        <div class="layout-page">
              ...
              <div class="row">
                <div class="col-lg-12 mb-4 order-0">
                  ...
                  <div class="card mb-4 col-lg-6">
                    <h5 class="card-header text-center text-capitalize"><?php echo $lang["rangereport"]; ?></h5>
                    <h6 class="text-center"><?php echo $lang["rangereportparagraph"]; ?></h6>
                    <div class="card-body">
                      <form action="rangereport.php" method="POST">
                     <!-- input -->
                      <div class="mb-3 row">
                        <label for="html5-date-input" class="col-md-2 text-nowrap col-form-label"><?php echo $lang["fromdate"]; ?></label>
                        <div class="col-md-10">
                          <input class="form-control" required type="date" name="fromdate" id="html5-date-input" />
                        </div>
                      </div>
                      <!-- input -->
                      <!-- input -->
                      <div class="mb-3 row">
                        <label for="html5-date-input" class=" text-nowrap col-md-2 col-form-label"><?php echo $lang["todate"]; ?></label>
                        <div class="col-md-10">
                          <input class="form-control" required type="date" name="todate" id="html5-date-input" />
                        </div>
                      </div>
                      <!-- input -->
                      <!-- input -->
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                         <button type="submit" name="checkdates" class="btn btn-primary"><?php echo $lang["save"]; ?></button>
                        </div>
                      </div>
                      <!-- input -->
                    </form>
          ...
          <div class="card mb-2">
                    ...
                    <!-- Bordered Table -->
              <div class="card">
                <h5 class="card-header"><?php echo $lang["salesreport"]."&nbsp;&nbsp;&nbsp;&nbsp;".$fromdate."&nbsp;&nbsp;&nbsp; - &nbsp;&nbsp;&nbsp;".$todate; ?></h5>
                <div class="card-body">
